#!/usr/bin/env python3
"""Exercise every registered tool against the live Aruba Central and report what is broken.
...
carry device names, client MACs and site names into logs.
...
async def main_async(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        results = await run_probes(
            ...
            # Network data must not reach the report: an error routinely
            # quotes the device, client MAC or site it was asked about.
            # --traceback still shows the full text on the operator's own
...
def main() -> None:
    ...
    # Serial by default: Central rate-limits per tenant and several of these
    # tools page through every device — a burst of them is a worse neighbour
